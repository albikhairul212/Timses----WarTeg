 ...
 * @author UMAM
 */
public class Struk8 extends javax.swing.JFrame {

    /**
     * Creates new form Struk8
     */
    public Struk8() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Struk8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
