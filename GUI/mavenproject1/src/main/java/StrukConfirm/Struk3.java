 ...
 * @author UMAM
 */
public class Struk3 extends javax.swing.JFrame {

    /**
     * Creates new form Struk3
     */
    public Struk3() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(990, 460, 340, 60);
        ...
        Jumlah.setBounds(720, 460, 120, 60);
        ...
        Transfer.setBounds(780, 660, 150, 150);
        ...
        Cod.setBounds(1060, 660, 160, 150);

        Harga.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/konfirmasi ps.png"))); // NOI18N
    ...
    private void PlusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PlusActionPerformed
        ...
        int a2 = 11_699_000; // harga awal barang
        int hasil = a1 * a2 ;
        //input nilai
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Struk3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
